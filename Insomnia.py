...
def cnf_matrix_plotter(cm, classes):
    ...
    plt.title('Confusion Matrix_Task4')
    plt.colorbar()
    ...
    plt.show()
    plt.savefig('results/ConfusionMatrix_Task4.png')

df = pd.read_csv('Insomnia.csv')
print(df.shape)
#print(df.dtypes)
...
y_train_str[y_train_str == '1'] = 'Insomnia'
...
print(classification_report(y_test, y_pred, target_names=['Healthy','Insomnia']))
